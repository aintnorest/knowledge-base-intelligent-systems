...
| `interpretability` | Model-internals analysis (probes, influence functions, model editing): [causal-influence-control-persistent-memory](/dossiers/causal-influence-control-persistent-memory.md), [causal-influence-signature](/vault/causal-influence-signature.md), [side-effect-bounded-activation-steering](/vault/side-effect-bounded-activation-steering.md). |
...
| `alignment` | Training-objective-induced model behavior (sycophancy, truthfulness, reward hacking, scalable oversight), currently absorbed by `reliability`/`governance`: [understanding-sycophancy-language-models](/dossiers/understanding-sycophancy-language-models.md), [sycophancy](/vault/sycophancy.md), [sycophancy-large-language-models-causes-mitigations](/dossiers/sycophancy-large-language-models-causes-mitigations.md), [llms-are-biased-because-they-are-llms](/dossiers/llms-are-biased-because-they-are-llms.md). Flagged independently by three 2026-08-25 ingests; strongest candidate of the batch. |
| `evaluation-bias` | Systematic evaluator-side preference distortions independent of response quality (length, position, self-enhancement, formatting): [verbosity-bias-in-preference-evaluation](/vault/verbosity-bias-in-preference-evaluation.md), [human-anchored-judge-bias-measurement](/vault/human-anchored-judge-bias-measurement.md), [judge-bias-as-accuracy-parity](/vault/judge-bias-as-accuracy-parity.md), [learned-bias-fitting-reward-debiasing](/vault/learned-bias-fitting-reward-debiasing.md), [llm-as-judge-with-anti-inflation](/vault/llm-as-judge-with-anti-inflation.md). ~8 plausible carriers after the 2026-08-25 batch; near the promotion bar. |
| `uncertainty-quantification` | Model confidence, calibration, and uncertainty estimation, currently collapsed onto `reliability`/`evaluation`: [just-ask-for-calibration](/dossiers/just-ask-for-calibration.md), [sample-consistency-hallucination-detection](/vault/sample-consistency-hallucination-detection.md), [verbosity-as-uncertainty-signal](/vault/verbosity-as-uncertainty-signal.md), [verbosity-compensation](/vault/verbosity-compensation.md); adjacent: [latent-tool-necessity-routing](/vault/latent-tool-necessity-routing.md), [tool-availability-abstention](/vault/tool-availability-abstention.md). |
| `reward-modeling` | Reward-function design and reward-model training distinct from policy-optimization mechanics (the complement of `policy-optimization-mechanics` above): [rule-based-rewards](/vault/rule-based-rewards.md), [policy-adaptive-reward-bounds](/vault/policy-adaptive-reward-bounds.md), [learned-bias-fitting-reward-debiasing](/vault/learned-bias-fitting-reward-debiasing.md), [preference-data-feature-attribution](/vault/preference-data-feature-attribution.md), [prompted-preference-model-debiasing](/vault/prompted-preference-model-debiasing.md). |
| `shortcut-learning` | Spurious-correlation exploitation and its debiasing (length shortcuts, confound-partitioned evaluation): [fimi-rm-bias-fitting-length-bias](/dossiers/fimi-rm-bias-fitting-length-bias.md), [confound-partitioned-accuracy](/vault/confound-partitioned-accuracy.md), [exemplar-copy-leakage](/vault/exemplar-copy-leakage.md). |
